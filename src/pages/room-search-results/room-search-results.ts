...
export class RoomSearchResultsPage {
  ...
  constructor(public navCtrl: NavController, 
    ...
    let toast = this.events_manager.getCloseButtonToast().subscribe( close => {
      if( close ) {
        toast.unsubscribe();
  ...
  confirmReservation( meetingRoom:any ) {
    ...
    this.meeting_provider.generateReservation( reservation )
                         .subscribe( respone => {
                           ...
                           this.events_manager.setIsLoadingEvent( false );
                           this.events_manager.setGeneralNotificationMessage('Reservación creada con éxito','success','bottom',true,'OK',5000);
